...
<?php
	...
	$get_curr_group =  mysqli_real_escape_string($con, $_GET['group_id']);
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6 d-flex justify-content-end">
				<a href="/groups.php" class="btn btn-info"><i class="fa fa-window-close"></i></a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
          ...
          <div class="col-12">
			...
			<form id="add_partner" action="api/action_network.php">
				  ...
				  <div class="form-group col-md-12">
					<label for="group">Ընտրել խումբը</label>
						
					<select name="group" id="groups" class="form-control">
						<?php 
						
						$query_groups = mysqli_query($con, "SELECT * FROM shop_group");
						while($groups_array = mysqli_fetch_array($query_groups)):
						?>

							<option value="<?php echo $groups_array['id']; ?>" <?php if($get_curr_group == $groups_array['id']){ echo 'selected'; } ?>><?php echo $groups_array['group_name']; ?> </option>
...
console.log(check_id);
    ...
    $.ajax({
        ...
        data: {shop_id: check_id, check_group_id: check_group_id, check_active: check_active},
        success: function(){
           // alert ('minpen');

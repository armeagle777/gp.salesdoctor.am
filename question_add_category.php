...
<?php
	...
	if($action == 'delete') {
		...
		mysqli_query($con, "DELETE FROM question_categrory WHERE id = '$question_id'");
		mysqli_query($con, "DELETE FROM question_categrory WHERE category_parrent = '$question_id'");
	...
	if($question_id == '' AND $action == 'add') {
		...
		if($question_type1 == '0') {
			...
			$query_add = "INSERT INTO question_categrory (category_name, category_parrent, category_type) VALUES ('$question_name', '0', '1')";
		...
		if($question_type1 != '0' and $question_type2 == '0') {
			...
			$query_add = "INSERT INTO question_categrory (category_name, category_parrent, category_type) VALUES ('$question_name', '$question_type1', '1') ";
			mysqli_query($con, $query_add);

		}	
		if($question_type1 != '0' and $question_type2 != '0') {
			
			$query_add = "INSERT INTO question_categrory (category_name, category_parrent, category_type) VALUES ('$question_name', '$question_type2', '1') ";
			mysqli_query($con, $query_add);
		...
		echo "
		<script type='text/javascript'>
		window.location.href = '/question_add_category.php';
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
			...
			<form id="add_partner" action="/question_add_category.php">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-3">
							<label for="question_type1">Խումբ</label>
								...
								<?php 
									$query_data_category1 = mysqli_query($con, "SELECT * FROM question_categrory WHERE category_parrent='0' AND category_type = '1' ");

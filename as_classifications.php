      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6 d-flex justify-content-end">
			<a href="/action_as_classifications.php?action=add" class="btn btn-primary">Ավելացնել նորը</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>				  
                    <?php           
                      $sql="SELECT * FROM as_classifications";
                      ...
                      <tr>
                        ...
                        <td style="width:150px;">
                          <a    class="btn btn-primary btn-sm" 
                                href="/action_as_classifications.php?action=edit&id=<?php echo $id; ?>"
                                title="Խմբագրել">
...
<script>
	...
	$("#click_delete").click(function() {
        ...
        $.ajax({
            type: "POST",
            url: "api/add_classification.php",
            data: {id:client_to_delete, action:'delete'},

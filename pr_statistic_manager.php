          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
				 ...
				 <form action="/pr_statistic_manager.php" id="statistics_form"> 
				  <div class="form-row">
                ...
                <table id="example1" class="table table-bordered table-striped">
				  ...
				  <?php 				  
					...
					$query_shops_statistic = mysqli_query($con, "SELECT *, SUM(order_last_summ) AS order_total, shops.static_manager AS real_static_manager FROM pr_orders_document LEFT JOIN shops ON pr_orders_document.shop_id = shops.shop_id WHERE YEAR(pr_orders_document.document_date) = '$year_selected' $query_paytype_select $query_group_selected $query_manager_select GROUP BY shops.static_manager");
				  ...
				  <tr> 
					...
					<td>
						...
						<?php
						$january_array = mysqli_fetch_array(mysqli_query($con, "SELECT SUM(order_last_summ) AS january FROM pr_orders_document LEFT JOIN shops ON pr_orders_document.shop_id = shops.shop_id WHERE order_type='1' AND MONTH(document_date) = '1' AND YEAR(document_date) = '$year_selected' AND shops.static_manager = '$manager_cur_id' $query_group_selected  $query_paytype_select "));
						
						$january_array_veradardz = mysqli_fetch_array(mysqli_query($con, "SELECT SUM(order_last_summ) AS january_veradardz FROM pr_orders_document LEFT JOIN shops ON pr_orders_document.shop_id = shops.shop_id WHERE order_type='2' AND MONTH(document_date) = '1' AND YEAR(document_date) = '$year_selected' AND shops.static_manager = '$manager_cur_id' $query_group_selected  $query_paytype_select "));
						
						echo $january_array['january'] - $january_array_veradardz['january_veradardz'];
						
						$year_total = $year_total + $january_array['january'] - $january_array_veradardz['january_veradardz'];
						?>
					...
					<td>
						...
						<?php
						$january_array = mysqli_fetch_array(mysqli_query($con, "SELECT SUM(order_last_summ) AS january FROM pr_orders_document LEFT JOIN shops ON pr_orders_document.shop_id = shops.shop_id WHERE order_type='1' AND MONTH(document_date) = '2' AND YEAR(document_date) = '$year_selected' AND shops.static_manager = '$manager_cur_id' $query_group_selected  $query_paytype_select "));
					...
					<td>
						...
						<?php
						$january_array = mysqli_fetch_array(mysqli_query($con, "SELECT SUM(order_last_summ) AS january FROM pr_orders_document LEFT JOIN shops ON pr_orders_document.shop_id = shops.shop_id WHERE order_type='1' AND MONTH(document_date) = '3' AND YEAR(document_date) = '$year_selected' AND shops.static_manager = '$manager_cur_id' $query_group_selected $query_paytype_select  "));
					...
					<td>
						...
						<?php
						$january_array = mysqli_fetch_array(mysqli_query($con, "SELECT SUM(order_last_summ) AS january FROM pr_orders_document LEFT JOIN shops ON pr_orders_document.shop_id = shops.shop_id WHERE order_type='1' AND MONTH(document_date) = '4' AND YEAR(document_date) = '$year_selected' AND shops.static_manager = '$manager_cur_id' $query_group_selected $query_paytype_select "));
					...
					<td>
						...
						<?php
						$january_array = mysqli_fetch_array(mysqli_query($con, "SELECT SUM(order_last_summ) AS january FROM pr_orders_document LEFT JOIN shops ON pr_orders_document.shop_id = shops.shop_id WHERE order_type='1' AND MONTH(document_date) = '5' AND YEAR(document_date) = '$year_selected' AND shops.static_manager = '$manager_cur_id' $query_group_selected $query_paytype_select "));
					...
					<td>
						...
						<?php
						$january_array = mysqli_fetch_array(mysqli_query($con, "SELECT SUM(order_last_summ) AS january FROM pr_orders_document LEFT JOIN shops ON pr_orders_document.shop_id = shops.shop_id WHERE order_type='1' AND MONTH(document_date) = '6' AND YEAR(document_date) = '$year_selected' AND shops.static_manager = '$manager_cur_id' $query_group_selected $query_paytype_select "));
					...
					<td>
						...
						<?php
						$january_array = mysqli_fetch_array(mysqli_query($con, "SELECT SUM(order_last_summ) AS january FROM pr_orders_document LEFT JOIN shops ON pr_orders_document.shop_id = shops.shop_id WHERE order_type='1' AND MONTH(document_date) = '7' AND YEAR(document_date) = '$year_selected' AND shops.static_manager = '$manager_cur_id' $query_group_selected $query_paytype_select "));
					...
					<td>
						...
						<?php
						$january_array = mysqli_fetch_array(mysqli_query($con, "SELECT SUM(order_last_summ) AS january FROM pr_orders_document LEFT JOIN shops ON pr_orders_document.shop_id = shops.shop_id WHERE order_type='1' AND MONTH(document_date) = '8' AND YEAR(document_date) = '$year_selected' AND shops.static_manager = '$manager_cur_id' $query_group_selected $query_paytype_select "));
					...
					<td>
						...
						<?php
						$january_array = mysqli_fetch_array(mysqli_query($con, "SELECT SUM(order_last_summ) AS january FROM pr_orders_document LEFT JOIN shops ON pr_orders_document.shop_id = shops.shop_id WHERE order_type='1' AND MONTH(document_date) = '9' AND YEAR(document_date) = '$year_selected' AND shops.static_manager = '$manager_cur_id' $query_group_selected $query_paytype_select "));
					...
					<td>
						...
						<?php
						$january_array = mysqli_fetch_array(mysqli_query($con, "SELECT SUM(order_last_summ) AS january FROM pr_orders_document LEFT JOIN shops ON pr_orders_document.shop_id = shops.shop_id WHERE order_type='1' AND MONTH(document_date) = '10' AND YEAR(document_date) = '$year_selected' AND shops.static_manager = '$manager_cur_id' $query_group_selected $query_paytype_select "));
					...
					<td>
						...
						<?php
						$january_array = mysqli_fetch_array(mysqli_query($con, "SELECT SUM(order_last_summ) AS january FROM pr_orders_document LEFT JOIN shops ON pr_orders_document.shop_id = shops.shop_id WHERE order_type='1' AND MONTH(document_date) = '11' AND YEAR(document_date) = '$year_selected' AND shops.static_manager = '$manager_cur_id' $query_group_selected $query_paytype_select "));
					...
					<td>
						...
						<?php
						$january_array = mysqli_fetch_array(mysqli_query($con, "SELECT SUM(order_last_summ) AS january FROM pr_orders_document LEFT JOIN shops ON pr_orders_document.shop_id = shops.shop_id WHERE order_type='1' AND MONTH(document_date) = '12' AND YEAR(document_date) = '$year_selected' AND shops.static_manager = '$manager_cur_id' $query_group_selected $query_paytype_select "));

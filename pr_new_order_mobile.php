						  ...
						  <div class="form-group col-md-6">
							<label for="address">Մարզ</label>
								...
								<select name="region" id="region" class="form-control">
                                    ...
                                    $selected ="selected";
                                    if($region_id == $_GET['region']) {
                                        echo $selected;
                                    }

                                    ?> value="<?php echo $region_id; ?>" <?php if($query_shop_district_region['region'] == $region_id){echo "selected";} ?>> <?php echo $region_name; ?></option>
				     ...
				     <select name="district" id="district" class="form-control">
                                                ...
                                                if ($my_shop != 'null'):
                                                    ...
                                                    if ($_GET['district']) {
                                                        ...
                                                        echo $query_shop_district_region = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM shops LEFT JOIN region ON shops.region = region.id LEFT JOIN district ON shops.district = district.id WHERE district.id = '$district' "));
                                                    }

                                                    ?>


                                                    <option><?php echo $query_shop_district_region['district_name']; ?>
				  ...
				  <div class="form-group col-md-6">
					<label for="shop">Խանութ </label>`
                      <select name="shop" id="shop" class="form-control">
                                                <?php if ($my_shop != 'null') {
                                                    ?>
                                                    <option value="<?php echo $shop_array['shop_id']; ?>"><?php echo $shop_array['shop_id']; ?>
                                                        .<?php echo $shop_array['name']; ?>
                                                        - <?php echo $shop_array['address']; ?></option>
                                                <?php } else {
                                                    ?>
                                                    <option value="0">Ընտրել</option>
                                                <?php } ?>
				  ...
				  <div class="form-group col-md-6">
					...
					<select name="product_group" id="product_group" class="form-control">
						...
						while($array_pr_groups = mysqli_fetch_array($query_product_group)){
                            $product_groupset = $array_pr_groups['id'];
                           echo $product_groupget = $_GET['product_group'];
                           $selected ="selected";
                            if($product_groupset == $product_groupget){
                                echo "<option selected value='{$array_pr_groups['id']}'>{$array_pr_groups['group_name']}</option>";
                            }else{

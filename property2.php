      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6 d-flex justify-content-end">
			<a href="/action_property2.php" class="btn btn-primary">Ավելացնել նորը</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
				 ...
				 <?php 
					...
					$query = mysqli_query($con, "SELECT * FROM pr_property2 ORDER by id DESC");
					while ($array_property = mysqli_fetch_array($query)):
					$pr_property_id = $array_property['id'];
					$pr_property2 = $array_property['property_2'];
				 ?> 
				  
                  <tr>
                    <td><?php echo $pr_property_id; ?></td>
                    <td><?php echo $pr_property2; ?>
...
<script>
    ...
    $.ajax({
           ...
           data: {property_id:client_to_delete, action:'delete_property_2'},

  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Ապրանքների խմբեր</h1>
          </div>
          <div class="col-sm-6 d-flex justify-content-end">
			<a href="/action_pr_groups.php?action=add" class="btn btn-primary">Ավելացնել նորը</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
				 ...
				 <?php 
					...
					$query = mysqli_query($con, "SELECT * FROM pr_groups ORDER by id DESC");
				 ...
				 ?> 
                  ...
                  <tr>
                    ...
                    <td style="width:150px;">
						<a href="/action_pr_groups.php?action=edit&group_id=<?php echo $group_id; ?>" class="btn btn-success btn-sm rounded-0" title="Խմբագրել"><i class="fa fa-edit"></i></a>

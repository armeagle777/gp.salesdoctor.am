...
<?php
	...
	if($action == 'delete') {
		...
		window.location.href = '/question_company_to_question1.php?company_id=$company_id';
...
<form id="add_partner" action="/question_company_to_question1.php">
		   ...
		   <table id="example1" class="table table-bordered table-striped">
				 ...
				 ?> 
                  ...
                  <tr>
                    ...
                    <td><?php echo $question_1['category_name']; ?> > <?php echo $question_2['category_name']; ?> > <?php echo $question_3['category_name']; ?></td>
					...
					$query_solutions = mysqli_query($con, "SELECT * FROM question_solution WHERE question_id3 = '$question_id' ");
					while($array_solutions = mysqli_fetch_array($query_solutions)):
					$curr_solution_id = $array_solutions['id'];
					
					$query_ceck_done = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM question_company_to_solution WHERE company_id = '$company_id' AND question_id = '$question_id' AND solution_id = '$curr_solution_id' "));
					...
					?>
						...
						<input class="form-check-input solution_client" type="checkbox" value="1" id="solution_<?php echo $array_solutions['id']; ?>" data-companyid="<?php echo $company_id; ?>" data-questionid="<?php echo $question_id; ?>" data-solutionid="<?php echo $array_solutions['id']; ?>" <?php if($query_ceck_done['id'] > 0) {echo "checked"; } ?>> 
						
						<label class="form-check-label" for="solution_<?php echo $array_solutions['id']; ?>">
						   <?php echo $array_solutions['solution_name'] ?>
						  </label>
						
						<input type="text" class="form-control solution_comment comment_<?php echo $array_solutions['id'] ?>" placeholder="Մեկնաբանություն" id="comment_<?php echo $array_solutions['id'] ?>" data-companyid="<?php echo $company_id; ?>" data-questionid="<?php echo $question_id; ?>" data-solutionid="<?php echo $array_solutions['id']; ?>" value="<?php echo $query_ceck_done['solution_comment']; ?>">
